...
class ListCustomerTickets extends ListRecords
{
    ...
    public function getHeader(): ?\Illuminate\Contracts\View\View
    {
        ...
        try {
            ...
            if ($storeOptions->count() > 1) {
                return view('filament.resources.customer-ticket-resource.pages.list-customer-tickets-header', [
            ...
            \Log::error('CustomerTicketResource header error: ' . $e->getMessage());
        }
    ...
    public function getTableQuery(): ?\Illuminate\Database\Eloquent\Builder
    {
        ...
        // スーパーアドミンは全回数券表示（店舗フィルターがある場合は適用）
