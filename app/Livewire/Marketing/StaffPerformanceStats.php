...
class StaffPerformanceStats extends Component
{
    ...
    public function mount(string $period = 'month', ?int $store_id = null, ?string $startDate = null, ?string $endDate = null): void
    {
        ...
        $this->staffData = $service->getStaffPerformance($this->period, $this->store_id, $this->startDate, $this->endDate);
    }
    ...
    public function updateData($filters): void
    {
        ...
        $service = new MarketingAnalyticsService();
        $this->staffData = $service->getStaffPerformance($this->period, $this->store_id);
    }

    public function render()
    {
        return view('livewire.marketing.staff-performance-stats');
    }
}