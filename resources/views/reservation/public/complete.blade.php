        ...
        <div class="bg-white rounded-lg shadow-sm p-8">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-md p-6 mb-6 text-center">
                ...
                <div class="mb-4 space-y-3">
                    <!-- LIFF版（推奨） -->
                    <a href="https://liff.line.me/{{ $reservation->store->line_liff_id }}?reservation={{ $reservation->reservation_number }}" 
                    ...
                    <a href="{{ url('/line/link?reservation=' . $reservation->reservation_number) }}" 
                       class="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 text-white font-medium text-base rounded-lg hover:bg-blue-600 shadow w-full justify-center">
                        🌐 ブラウザで連携する
                    </a>
                    
                    <p class="text-sm text-gray-600 text-center">上のボタンで連携できない場合は下のボタンをお試しください</p>
                </div>
