<div class="p-4 sm:p-6">
    ...
    @else
        ...
        @elseif($order->status === 'shipped')
            <div class="flex flex-col gap-3 px-3 py-3 bg-amber-50 border border-amber-200 rounded-lg">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    <a href="{{ route('fc-order.delivery-slip', $order) }}" target="_blank"
                       class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg text-sm font-medium transition whitespace-nowrap">
        ...
        @elseif($order->status === 'delivered')
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-3 py-3 bg-green-50 border border-green-200 rounded-lg">
