...
<div class="flex items-center gap-2">
    ...
    <button
        ...
        class="relative flex items-center justify-center w-10 h-10 text-white transition bg-blue-600 rounded-lg hover:bg-blue-700 focus:bg-blue-700 focus:outline-none"
        aria-label="AIヘルプ"
        title="AIヘルプチャット"
    >
